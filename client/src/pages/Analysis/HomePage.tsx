...
/>
      ...
      <section className="py-20 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
  to="/analysis/demo"
  className="inline-flex items-center justify-center bg-transparent border border-[#9945FF] text-[#9945FF] hover:bg-[#9945FF] hover:text-white transition-all duration-300 px-6 py-3 rounded-lg font-medium glow-border hover:scale-105"
>
  View Demo Analysis
